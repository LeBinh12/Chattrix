const currentImports = {};
      ...
      let moduleMap = {
"./mount":()=>{
      dynamicLoadingCss(["style-GYeDSRQ4.css"], false, './mount');
      return __federation_import('./assets/__federation_expose_Mount-DMCG7naz.js').then(module =>Object.keys(module).every(item => exportSet.has(item)) ? () => module.default : () => module)},};
      const seen = {};
        ...
        cssFilePaths.forEach(cssPath => {
         ...
         if (baseUrl) {
          ...
          if (dontAppendStylesToHead) {
            const key = 'css__chat__' + exposeItemName;
