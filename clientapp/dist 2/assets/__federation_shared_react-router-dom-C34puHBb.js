...
function UNSTABLE_TransitionEnabledRouterProvider({
  ...
  let [revalidating, startRevalidation] = React3$1.useTransition();
  let [state, setState] = React3$1.useState(router.state);
  ...
  return /* @__PURE__ */ React3$1.createElement(React3$1.Fragment, null, /* @__PURE__ */ React3$1.createElement(DataRouterContext.Provider, { value: dataRouterContext }, /* @__PURE__ */ React3$1.createElement(
    ...
    /* @__PURE__ */ React3$1.createElement(FetchersContext.Provider, { value: fetcherData.current }, /* @__PURE__ */ React3$1.createElement(
      Router,
      {
        basename,
        location: state.location,
