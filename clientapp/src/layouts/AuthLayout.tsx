...
export default function AuthLayout() {
  return (
    <main className="min-h-screen w-full flex bg-gray-50 overflow-y-auto lg:overflow-hidden">
      ...
      >
        ...
        {/* Mobile Logo */}
        <div className="lg:hidden flex items-center justify-center pt-12 pb-6 z-10">
          <img
            src="/src/assets/Logo-Dai-hoc-Dong-Thap.png"
            alt="Logo"
        ...
        {/* Form */}
        <div className="flex-1 flex items-start lg:items-center justify-center px-4 sm:px-6 lg:px-12 xl:px-20 pb-12 relative z-10">
