export default function ChatWindowSkeleton() {
  return (
    <div className="flex flex-col flex-1 h-screen bg-gradient-to-b from-brand-50 via-white to-brand-100 animate-pulse relative overflow-hidden">
      {/* Header Skeleton */}
      <div className="flex items-center gap-3 bg-white/80 backdrop-blur-md px-4 py-3 border-b border-brand-100 shadow-sm">
      ...
      <div className="flex-1 p-4 space-y-6 overflow-hidden relative">
        ...
        <div className="relative z-10 space-y-5">
          ...
          <div className="flex items-start gap-2 justify-end">
            <div className="space-y-2">
              <div className="h-10 bg-brand-200/70 rounded-2xl w-56 shadow-sm"></div>
              <div className="h-10 bg-brand-200/70 rounded-2xl w-40 shadow-sm"></div>
            </div>
          </div>
          ...
          {/* Phải */}
          <div className="flex items-start gap-2 justify-end">
            <div className="h-10 bg-brand-200/70 rounded-2xl w-52 shadow-sm"></div>
          </div>
      ...
      {/* Input Skeleton */}
      <div className="bg-white/80 backdrop-blur-md px-4 py-3 border-t border-brand-100 shadow-sm">
